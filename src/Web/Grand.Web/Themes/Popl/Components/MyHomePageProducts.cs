...
{
    public class MyHomePageProductsViewComponent : BaseViewComponent
    {
        #region Fields
        ...
        #region Constructors
        public MyHomePageProductsViewComponent(
        ...
        public async Task<IViewComponentResult> InvokeAsync(int? productThumbPictureSize)
        {
            ...
            IEnumerable<MyProductOverviewModel> model = await _mediator.Send(new MyGetProductOverview() {
