...
$(function () {
    ...
    $('.article_content iframe, .page iframe').wrap('<div class="lazyframe" data-ratio="16:9"></div>');
...
$(function () {
    $('body').on("click", ".featured-collection-section .yotpo.bottomLine.yotpo-small a, .yotpo-num-of-reviews", function (evt) {
        evt.preventDefault();
        //console.log("click");
        var b = $('#yotpo_testimonials_btn');
        if (b.length > 0)
            b.click();
    });
